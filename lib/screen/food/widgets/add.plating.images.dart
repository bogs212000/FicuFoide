...
class _AddPlatingWidgetsState extends State<AddPlatingWidgets> {
  ...
  Future<List<String>> _getPictures() async {
    ...
    try {
      ...
      FirebaseStorage.instance.ref().child('Plating${foodInfoPageDocName!}');
  ...
  Future<void> _openImagePicker() async {
    ...
    if (pickedImage != null) {
      ...
      Reference storageReference = FirebaseStorage.instance.ref().child('Plating${foodInfoPageDocName!}/$fileName');
